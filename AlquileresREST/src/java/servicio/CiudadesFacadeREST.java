 ...
 */
@Stateless
@Path("db.entidades.ciudades")
public class CiudadesFacadeREST extends AbstractFacade<Ciudades> {

    @PersistenceContext(unitName = "AlquileresRESTPU")
    private EntityManager em;

    public CiudadesFacadeREST() {
        super(Ciudades.class);
        this.em = Persistence.createEntityManagerFactory("AlquileresRESTPU").createEntityManager();
    }
